...
from .discount import urlpatterns as discount_urlpatterns 


urlpatterns = (
    []  + menu_urlpatterns + customer_urlpatterns + order_urlpatterns + user_urlpatterns + bill_request_urpatterns + rating_urlpatterns + hashgenerate_urlpatterns + discount_urlpatterns
)