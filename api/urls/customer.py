...
from api.views.customer import CustomerNormalRegister, CustomerNormalLoginView, CustomerGuestLoginCreate, CustomerGoogleLoginView, CustomerGoogleRegister, CustomerDetailsAPIView,CustomerAddDetailsAPIView
...
from api.views.customer import ReduceCustomerLoyaltyPoints, CustomerOrderItemHistory, CustomerOrderHistoryDate
urlpatterns += [
